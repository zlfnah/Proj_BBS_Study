...
totalRecord = bMgr.getTotalCount();   // 전체 데이터 수 반환
	...
	<div id="wrap">
		...
		<main id="main" class="list">   <!-- 본문영역 html 템플릿 시작 -->
			...
			<div id="pageInfo" class="flex-container">
				<span>전체 게시글 :  <%=totalRecord%> 개</span>
							...
							<form name="searchFrm" class="flex-container"
								...
								<div>
									<input type="text" name="keyWord"
									  id="keyWord" size="16" maxlength="30">
								</div>
								<div>
